function init_hemul() {
	...
	var hemulDiv = '<div id="hemul" ng-app="Hemul" ng-include="\'' + hemulHtml + '\'"></div>';
  	var hemulModal = '<div id="hemulModal" style="z-index:3000" class="modal fade" role="dialog" aria-labelledby="mymodallabel" aria-hidden=true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h2 class="modal-title" id="myModalLabel">Hemul</h2></div><div class="modal-body" style="min-height: 500px;">' + hemulDiv + '</div><div class="modal-footer">' + hemulFooter() + '</div></div></div></div></div>';
